...
function Interview({ params }) {
  const [interviewData, setInterviewData] = useState(null); // Default to null, not undefined
  const [webCamEnabled, setWebCamEnabled] = useState(false);
  const [webCamError, setWebCamError] = useState(null); // Track webcam errors
  ...
  const GetInterviewDetails = async () => {
    ...
    console.log(result);
    setInterviewData(result[0]); // Make sure to set the first result
  };
    ...
    <div className="my-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        {interviewData ? (
          ...
          <p>Loading interview details...</p> // Show this while data is loading
        )}
